...
public class QtdEmp extends JFrame{

	public RegistroEmp janMeAbriu;
	int linhaSelec;
	private JLabel qtd, nome, cod, prod, codprod;
	private JTextField txtQtd;
	private JButton concluir, voltar;
	
	public QtdEmp(RegistroEmp meAbriu, int plinhaSelec){
	...
	private void criaComponentes(){
		...
		prod = new JLabel(janMeAbriu.janMeAbriu.janMeAbriu.cadastroProdEmp.get(linhaSelec).getNome());
		...
		codprod = new JLabel(janMeAbriu.janMeAbriu.janMeAbriu.cadastroProdEmp.get(linhaSelec).getQtd() + "");
	...
	private void criaAcoes(){
		...
		concluir.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(intqtd <= janMeAbriu.janMeAbriu.janMeAbriu.cadastroProdEmp.get(linhaSelec).getQtd()){
				conta = janMeAbriu.janMeAbriu.janMeAbriu.cadastroProdEmp.get(linhaSelec).getQtd() - intqtd;
				janMeAbriu.janMeAbriu.janMeAbriu.cadastroProdEmp.get(linhaSelec).setQtd(conta);
		...
		voltar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				QtdEmp.this.dispose();
				RegistroEmp regis = new RegistroEmp(janMeAbriu.janMeAbriu);
